...
End If	
 %>
<body>
<form id="form1" name="form1" method="post" action="chk_two.asp?event=start">
  <table width="500" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000">
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#FFFFFF"><%= date() %>&nbsp;<%= request.Cookies("dd")%></td>
    </tr>
    <tr>
      <td width="120" rowspan="4" bgcolor="#FFFFFF">计划<%= rs("dictate_no") %></td>
      <td width="80" bgcolor="#FFFFFF">部番</td>
      <td bgcolor="#FFFFFF"><input name="bf" type="text" id="bf" value="<%= rs("goods_name") %>" size="16" /></td>
      <td width="80" bgcolor="#FFFFFF">班别</td>
      <td width="100" bgcolor="#FFFFFF"><input name="bb" type="text" id="bb" size="16" /></td>
    </tr>
    <tr>
    ...
    <% 
	 ...
	 %>
	<tr>
      <td bgcolor="#FFFFFF"><a href="dbl_jhtwo.asp?TxtKey=<%= rs("id") %>">计划<%= rs("dictate_no") %></a></td>
