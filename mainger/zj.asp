...
<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#666666">
  <tr>
    <td width="25%"><font color="#FFFFFF"><strong>操作人</strong></font></td>
    <td width="25%"><font color="#FFFFFF"><strong>操作时间</strong></font></td>
    <td width="25%"><font color="#FFFFFF"><strong>操作事件</strong></font></td>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
  <tr>
    <td width="25%">总共<%= ThisRsCount %>条记录,<%= ThisPageSize %>条记录/页,总共<%= ThisPageCount %>页,当前第<%= ThisCurrentPage %>页</td>
