...
<body>
<table width="1050" border="1" align="center" cellpadding="4" cellspacing="1" bordercolor="#000000" id="mytable">
  ...
  <tr style="font-weight:bold;">    
    ...
    <td width="40">PO</td>
    <td width="60">纳期</td>
    <td width="70"><a href="print.asp">担当</a></td>
    <td width="60">备注</td>
    <td width="60">时间安排</td>
    <td width="60">生管说明</td>
  </tr>
...
If TxtKey="" Then
	call CreateRs(rs,"select * from trymolde where addtime='"&date()&"' and okfolg='"&int(0)&"'Order By 生管确认机台 DESC ",1,1)
		if rs.eof or rs.bof then
			response.End()
		end if
Else
	call CreateRs(rs,"select * from trymolde Where addtime like '%"&TxtKey&"%' Order By 生管确认机台 DESC",1,1)
		if rs.eof or rs.bof then
